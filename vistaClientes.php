...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <div class="container">
        <div class ="text-right"><a href="NuevoCliente.php" class="btn btn-primary" style="margin-top: 30px"><span class="w3-badge w3-green"><i class='fas fa-plus'></i></span>Nuevo Cliente</a></div>
...
<!-- Modal para hacer la modificacion del cliente  -->
<div class="modal fade" id="MuestraFRM">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
      
        <div class="modal-header">
          <h4 class="modal-title">Modificacion del Cliente</h4>
...
<script type="text/javascript" src="js/controllerCliente.js"></script>
</body>
</html>